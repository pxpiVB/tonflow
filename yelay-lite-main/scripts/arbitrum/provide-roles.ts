...
async function main() {
    ...
    const FUNDS_OPERATORS = ADDRESSES[42161].FUNDS_OPERATORS;
    const QUEUE_OPERATORS = ADDRESSES[42161].QUEUE_OPERATORS;
    const SWAP_REWARDS_OPERATOR = ADDRESSES[42161].SWAP_REWARDS_OPERATOR;
